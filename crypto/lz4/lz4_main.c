...
static int __init lz4_main_mod_init(void)
{
	int ret;
...
static void __exit lz4_main_mod_fini(void)
{
	crypto_unregister_alg(&alg_lz4hc);
	crypto_unregister_alg(&alg_lz4);
}

module_init(lz4_main_mod_init);
module_exit(lz4_main_mod_fini);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("LZ4/LZ4HC Compression Algorithm");
