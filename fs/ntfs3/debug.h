...
#define ntfs_malloc(s)		kmalloc(s, GFP_NOFS | __GFP_NOWARN)
#define ntfs_zalloc(s)		kzalloc(s, GFP_NOFS | __GFP_NOWARN)
#define ntfs_vmalloc(s)		kvmalloc(s, GFP_KERNEL | __GFP_NOWARN)
#define ntfs_free(p)		kfree(p)
#define ntfs_vfree(p)		kvfree(p)
#define ntfs_memdup(src, len)	kmemdup(src, len, GFP_NOFS | __GFP_NOWARN)
// clang-format on
