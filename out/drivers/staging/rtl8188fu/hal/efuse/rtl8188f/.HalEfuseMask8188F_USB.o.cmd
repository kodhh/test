cmd_drivers/staging/rtl8188fu/hal/efuse/rtl8188f/HalEfuseMask8188F_USB.o := aarch64-linux-android-gcc -Wp,-MD,drivers/staging/rtl8188fu/hal/efuse/rtl8188f/.HalEfuseMask8188F_USB.o.d -nostdinc -isystem /mnt/aarch64-linux-android-4.9/bin/../lib/gcc/aarch64-linux-android/4.9.x/include -I../arch/arm64/include -I./arch/arm64/include/generated/uapi -I./arch/arm64/include/generated  -I../include -I./include -I../arch/arm64/include/uapi -I../include/uapi -I./include/generated/uapi -include ../include/linux/kconfig.h -I../drivers/staging/rtl8188fu -Idrivers/staging/rtl8188fu -D__KERNEL__  -I../arch/arm64/include  -I../drivers/mstar2 -mlittle-endian -Wl,-fix-cortex-a53-843419 -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -fshort-wchar -Werror-implicit-function-declaration -Wno-format-security -fno-delete-null-pointer-checks -std=gnu89 -fno-peephole2 -fno-PIE -mgeneral-regs-only -DCONFIG_AS_LSE=1 -fno-asynchronous-unwind-tables -fno-pic -fno-delete-null-pointer-checks -O2 --param=allow-store-data-races=0 -DCC_HAVE_ASM_GOTO -Wframe-larger-than=1536 -fstack-protector-strong -Wno-unused-but-set-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -fno-var-tracking-assignments -g -femit-struct-debug-baseonly -fno-var-tracking -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fno-merge-all-constants -fmerge-constants -fno-stack-check -fconserve-stack -Werror=implicit-int -Werror=strict-prototypes -Werror=date-time -O1 -Wno-unused-variable -Wno-unused-value -Wno-unused-label -Wno-unused-parameter -Wno-unused-function -Wno-unused  -I../drivers/staging/rtl8188fu/include  -I../drivers/staging/rtl8188fu/hal/phydm -DCONFIG_RTL8188F -DCONFIG_MP_INCLUDED -DCONFIG_POWER_SAVING -DCONFIG_TRAFFIC_PROTECT -DCONFIG_LOAD_PHY_PARA_FROM_FILE -DREALTEK_CONFIG_PATH=\"\" -DCONFIG_CALIBRATE_TX_POWER_TO_MAX -DCONFIG_RTW_ADAPTIVITY_EN=0 -DCONFIG_RTW_ADAPTIVITY_MODE=0 -DWAKEUP_GPIO_IDX= -DCONFIG_BR_EXT '-DCONFIG_BR_EXT_BRNAME="'br0'"' -DDM_ODM_SUPPORT_TYPE=0x04 -DCONFIG_LITTLE_ENDIAN -DCONFIG_IOCTL_CFG80211 -DRTW_USE_CFG80211_STA_EVENT  -DMODULE -mcmodel=large  -DKBUILD_BASENAME='"HalEfuseMask8188F_USB"'  -DKBUILD_MODNAME='"rtl8188fu"' -c -o drivers/staging/rtl8188fu/hal/efuse/rtl8188f/.tmp_HalEfuseMask8188F_USB.o ../drivers/staging/rtl8188fu/hal/efuse/rtl8188f/HalEfuseMask8188F_USB.c

source_drivers/staging/rtl8188fu/hal/efuse/rtl8188f/HalEfuseMask8188F_USB.o := ../drivers/staging/rtl8188fu/hal/efuse/rtl8188f/HalEfuseMask8188F_USB.c

deps_drivers/staging/rtl8188fu/hal/efuse/rtl8188f/HalEfuseMask8188F_USB.o := \
  ...
  ../drivers/staging/rtl8188fu/hal/efuse/rtl8188f/HalEfuseMask8188F_USB.h \

drivers/staging/rtl8188fu/hal/efuse/rtl8188f/HalEfuseMask8188F_USB.o: $(deps_drivers/staging/rtl8188fu/hal/efuse/rtl8188f/HalEfuseMask8188F_USB.o)
